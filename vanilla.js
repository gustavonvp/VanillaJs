...
const client_id = "c26020c4f91740c9b287";
const client_secret = "01baf6e7544fe0d7f677258096506f25a776dc16";
*
*
*
*/

//encapsular esses dados, para evitar acesso externo de outras funções
(function() {
    const search = document.getElementById("search");
    const profile = document.getElementById("profile");
